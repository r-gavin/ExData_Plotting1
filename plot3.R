...
#ggplot(feb2007,
#      aes(as.POSIXlt(strftime(paste(feb2007$Date,feb2007$Time),"%Y-%m-%d %H:%M:%S"))),
#      bg = "white") + 
...
#           type = "l")
#      plot(as.POSIXlt(strftime(paste(Date,Time),"%Y-%m-%d %H:%M:%S")),Sub_metering_2,
#           type = "l", col = "red")
#      plot(as.POSIXlt(strftime(paste(Date,Time),"%Y-%m-%d %H:%M:%S")),Sub_metering_3,
#           type = "l", col = "blue")
#})       
